...
//	to find mem_add of labels
	public static int mem_addLabels = 1;  // Check whether mem_add starts from 0 or 1
...
//		Reads The file
		try {
			...
			FileInputStream file = new FileInputStream("C:\\Users\\Aditya Nangia\\Dropbox\\My PC (DESKTOP-DT6PM4O)\\Desktop\\ADITYA\\A College\\IIITD\\FIRST YEAR\\SECOND (WINTER) SEMESTER\\CSE112 - CO\\COAssignmentTest1.txt");       
			Scanner scVar = new Scanner(file);
			while(scVar.hasNextLine()) {
				String line = scVar.nextLine();
				String line2 = line;
			...
			FileInputStream file1 = new FileInputStream("C:\\Users\\Aditya Nangia\\Dropbox\\My PC (DESKTOP-DT6PM4O)\\Desktop\\ADITYA\\A College\\IIITD\\FIRST YEAR\\SECOND (WINTER) SEMESTER\\CSE112 - CO\\COAssignmentTest1.txt");       
			Scanner sc = new Scanner(file1);    //file to be scanned
...
//		mylabel: add R0 R1 R2
		...
		if (variable.containsKey(words[0].substring(0, words[0].length() - 1))) {
			throw new Exception("ERROR: Misuse of labels as variables in line " + linenumber);
		}
